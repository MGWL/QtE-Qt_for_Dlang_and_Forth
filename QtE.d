...
// QString
private extern (C) alias void*  function(wchar*, int) 			t_QString_wchar;
...
private extern (C) alias  void* function(void*, int)   			t_p_QWidget;
// QByteArray
...
int LoadQt(dll ldll, bool showError) {   ///  Загрузить DLL-ки Qt и QtE
	...
	version(Windows) {
	 ...
	 version(linux) {
		cQtCore = "libQtCore.so.4"; cQtGui = "libQtGui.so.4"; cQtE = "QtE.so.1.0.0"; cQtScript = "libQtScript.so.4";
		wQtCore = "libQtCore.so.4"; wQtGui = "libQtGui.so.4"; wQtE = "QtE.so.1.0.0"; wQtScript = "libQtScript.so.4";
	}
